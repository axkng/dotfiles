...
- You can use the Cloudflare observability MCP or wrangler to gather logs for troubleshooting
...
- grep: grep is aliased to rg or ripgred, which as different flags
